/*
    ...
    in this example—in a complex header file, so use complex0.h to avoid conflicts. 
    Use const whenever warranted.
...
#include <iostream>
using namespace std;
#include "Exercise_07_complex.h"  // to avoid confusion with complex.h
int main(){
    Complex a(3.0, 4.0);   // initialize to (3,4i)
    Complex c;
    cout << "Enter a complex number (q to quit):\n";
