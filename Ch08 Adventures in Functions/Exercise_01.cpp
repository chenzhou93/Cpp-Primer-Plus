 ...
 * and prints that string once. 
 * 
 * However, if a second, type int, 
 * argument is provided and is nonzero, 
 * the function should print 
 * the string a number of times equal to the number of times 
 ...
 * but it makes you use some of the techniques discussed in this chapter. 
...
void printString(char* s, int n=1);
int main(){
    char s[] = "test string";
    printString(s);
    printString(s, 5);
